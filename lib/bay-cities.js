...
var cities = ["san francisco, ca","san jose, ca", "san leandro, ca", "oakland, ca", "pleasanton, ca",
	      ...
	      "napa, ca","vacaville, ca", "hayward, ca", "union city, ca", "cupertino, ca", "mountain view, ca", "palo alto, ca", "antioch, ca",
	      ...
	      , "san rafael, ca", "novato, ca", "napa, ca", "sonoma, ca"];

$(function() {
    var mb = new MapBrowser({mapId: "map_canvas",  numColumns: 4, zoom: 10, points: cities});
    mb.render();
});
